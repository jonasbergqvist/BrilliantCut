...
namespace EPiTube.facetFilter.Widget.Edit
{
    public class EPiTubefacetFilterModule : ShellModule
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EPiTubefacetFilterModule"/> class.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <param name="routeBasePath">The route base path.</param>
        /// <param name="resourceBasePath">The resource base path.</param>
        public EPiTubefacetFilterModule(string name, string routeBasePath, string resourceBasePath)
        ...
        {
            viewModel.Routes.Add(new ModuleRoutePair(ResourceBasePath, new Dictionary<string, string> { { "moduleArea", "EPiTubefacetFilter" } }));
        }
    }
}
