...
namespace EPiTube.facetFilter.Core.Rest
{
    ...
    public class EPiTubeModelTransform : IModelTransform
    {
        ...
        public IEnumerable<IModelTransformContext> Execute(IEnumerable<IModelTransformContext> models)
        {
            ...
            {
                var epiTubeModel = model.Source as FacetContent;
        ...
        private static void SetHasChildrenForEntryContent(IModelTransformContext context, FacetContent source)
        {
        ...
        private static void SetCurrentCategoryRelation(IModelTransformContext context, PropertyDictionary properties, FacetContent source)
        {
